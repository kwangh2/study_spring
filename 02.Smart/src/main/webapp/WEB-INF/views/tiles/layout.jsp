							...
							<c:if test="${not empty loginInfo }">
								...
								<li class="nav-item dropdown"><a
									...
									<div class="dropdown-menu dropdown-menu-end"
										...
										<a class="dropdown-item" href="#!">${loginInfo.user_id } </a> <a
											class="dropdown-item" href="<c:url value='/member/changePassword'/>">비밀번호 변경</a> <a
											class="dropdown-item" href="#!">My Page</a>
