...
<form method="post" enctype="multipart/form-data" action="<c:url value='/member/join'/>">
	...
	<div>이메일 <input type="text" name="email" value="new001"></div>
	<div>주소 <input type="text" name="address" value="new001"></div>
	<div>우편번호 <input type="text" name="post" value="new001"></div>
	<div>전화번호 <input type="text" name="phone" value="new001"></div>
	<div>생년월일 <input type="text" name="birth" value="new001"></div>
